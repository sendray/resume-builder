      ...
      <header>
        <div className="header__content">
          <div className="header__identity">
            <div className="header__name">Sendrayaperumal Balathandayutham</div>
            <div className="header__desig">Lead UI Developer</div>
          </div>
          <div className="header__address">
            <div className="header__email">
              ...
              <span>bsendrayaperumal@gmail.com</span>
            </div>
